      ...
      <section className="py-6 dark:bg-coolGray-800 dark:text-coolGray-100">
        <div className="container p-4 mx-auto space-y-16 sm:p-10">
          <div className="space-y-4">
            <h3 className="text-2xl text-center font-bold leading-none sm:text-5xl">
              Meet our team
            </h3>
          </div>
          <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              <img
                alt=""
                className="object-cover h-56 mx-auto mb-4 bg-center rounded-sm dark:bg-coolGray-500"
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-m dark:text-coolGray-400">Founder/CEO</p>
              </div>
            </div>
            <div className="space-y-4">
              <img
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-m dark:text-coolGray-400">
            ...
            <div className="space-y-4">
              ...
              />
              <div className="flex flex-col items-center">
                <h4 className="text-xl font-semibold">Atenugbe Samuel</h4>
                <p className="text-m dark:text-coolGray-400">Manager</p>
              </div>
            </div>
            <div className="space-y-4">
              <img
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm dark:text-coolGray-400">Web developer</p>
                <div className="flex mt-2 space-x-2">
                  <a
                    rel="noopener noreferrer"
                    href="#"
                    title="Twitter"
                    className="dark:text-coolGray-400"
                  >
                    <svg
